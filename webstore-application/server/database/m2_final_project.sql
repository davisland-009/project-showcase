...
INSERT INTO product (product_sku, name, description, price, image_name) VALUES 
    ('MUG-023', 'Solar Geeks coffee mug',  'Start your day off right!',  14.99, '/img/GeekMug.jpg'),
    ('YET-001', 'Solar Geeks Yeti',        'Keep cool all day long.',    21.99, '/img/Yeti.jpg'),
    ('TEL-500', 'Galaxy Quest Teleporter', 'We do not recommend using this because it does not work yet.', 4449.99, '/img/Teleporter.jpg'),
    ('ART-256', 'Galactic poster',         'Beautiful view of a galaxy',  9.59, '/img/Poster.jpg'),
    ('TOY-978', 'Toy rocket',              'To infinite imagination',    39.99, '/img/Rocket.jpg'),
    ('EAT-235', 'Astronaut ice cream',     'As cold as space',            5.79, '/img/IceCream.jpg'),
    ('HAT-928', 'Solar Geeks baseball cap','Look stylish with our logo', 16.89, '/img/Hat.jpg'),
    ('LIT-612', 'Intro to Astrophysics',   'Learn about astrophysics',    7.99, '/img/Book.jpg');
